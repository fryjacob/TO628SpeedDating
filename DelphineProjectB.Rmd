...
library(ggplot2)
corravg <- data.frame(attributes = c("Attractive", "Sincere", "Intelligent", "Fun", "Ambitious", "Interests"), correlation=c(coratr, corsin, corint, corfun, coramb, corint))
...
corrm <- data.frame(attributes = c("Attractive", "Sincere", "Intelligent", "Fun", "Ambitious", "Interests"), correlation=c(cormatr, cormsin, cormint, cormfun, cormamb, cormint))
...
corrf <- data.frame(attributes = c("Attractive", "Sincere", "Intelligent", "Fun", "Ambitious", "Interests"), correlation=c(corfatr, corfsin, corfint, corffun, corfamb, corfint))
...
<!-- ## What people think the opposite sex wants vs what the opposite wants: CANNOT COMPUTE CAUSE NO AMB2-1 ANYMORE?? -->
<!-- ```{r, what ppl look for, echo = FALSE} -->
<!-- test3 <- -->
<!-- sdclean %>% -->
<!--   group_by(gender) %>% -->
