...
## Demographic
```{r}
top_race2 <- top_subset %>% group_by(gender, race) %>% summarise(Count = n())
total_race2 <- sdclean %>% group_by(gender, race) %>% summarise(Total = n())
top_race2$percent <- top_race2$Count/total_race2$Total

percent <- function(x, digits = 2, format = "f", ...) {
  paste0(formatC(1000 * x, format = format, digits = digits, ...), "‰")
}
top_race2$percent <- percent(top_race2$percent)

ggplot(top_race2, aes(x=factor(gender), y=percent, fill=factor(race))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Demographic of Top100 with Most Pairs") + labs(x="Gender",y="Per Mile")+theme(plot.title = element_text(size=15, face="bold", margin = margin(10, 0, 10, 0)))+theme(legend.title=element_blank())


top_race <- top_subset %>% group_by(race) %>% summarise(Count = n())
total_race <- sdclean %>% group_by(race) %>% summarise(Total = n())
top_race$percent <- top_race$Count/total_race$Total

percent <- function(x, digits = 2, format = "f", ...) {
  paste0(formatC(1000 * x, format = format, digits = digits, ...), "‰")
}
top_race$percent <- percent(top_race$percent)

ggplot(top_race, aes(x=factor(race), y=percent)) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Demographic of Top100 with Most Pairs") + labs(x="Race",y="Per Mile")+theme(plot.title = element_text(size=15, face="bold", margin = margin(10, 0, 10, 0)))+theme(legend.title=element_blank())
```
...
ggplot(top_field, aes(x=factor(gender), y=Count, fill=factor(field_cd))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Field of Top100 with Most Pairs") +theme(plot.title = element_text(size=15, face="bold", 
...
ggplot(top_group, aes(x=factor(gender), y=Count, fill=factor(group))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Career Group of Top100 with Most Pairs") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```
...
ggplot(top_age, aes(x=factor(gender), y=Count, fill=factor(range))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Age of Top100 with Most Pairs") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```
...
total_race <- sdclean %>% group_by(gender, race) %>% summarise(Total = n())
yes_race$percent <- yes_race$Count/total_race$Total

percent <- function(x, digits = 2, format = "f", ...) {
  paste0(formatC(1000 * x, format = format, digits = digits, ...), "‰")
}
yes_race$percent <- percent(yes_race$percent)

ggplot(yes_race, aes(x=factor(gender), y=percent, fill=factor(race))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Demographic of Top100 of Yes Decision") + labs(x="Gender",y="Number") + theme(plot.title = element_text(size=15, face="bold", margin = margin(10, 0, 10, 0)))+theme(legend.title=element_blank())
```
...
ggplot(yes_field, aes(x=factor(gender), y=Count, fill=factor(field_cd))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Field of Top100 of Yes Decision") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```
...
ggplot(yes_group, aes(x=factor(gender), y=Count, fill=factor(group))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Career Group of Top100 of Yes Decision") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```
...
ggplot(yes_age, aes(x=factor(gender), y=Count, fill=factor(range))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Age of Top100 of Yes Decision") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```