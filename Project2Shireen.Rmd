...
ggplot(race, aes(x=factor(Race), y= MatchRate )) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Demographic of Most Matches") + labs(x="Race",y="Match Rate%")+theme(plot.title = element_text(size=15, face="bold", margin = margin(10, 0, 10, 0)))+theme(legend.title=element_blank())
```
...
ggplot(top_field, aes(x=factor(gender), y=Count, fill=factor(field_cd))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Field of Top100 with Most Matches") +theme(plot.title = element_text(size=15, face="bold", 
...
ggplot(top_group, aes(x=factor(gender), y=Count, fill=factor(group))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Career Group of Top100 with Most Matches") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```
...
ggplot(top_age, aes(x=factor(gender), y=Count, fill=factor(range))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Age of Top100 with Most Matches") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```
...
ggplot(yes, aes(x=factor(Race), y= YesRate )) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Demographic of Most Yes Decisions") + labs(x="Race",y="Chance to say yes")+theme(plot.title = element_text(size=15, face="bold", margin = margin(10, 0, 10, 0)))+theme(legend.title=element_blank())
...
ggplot(yes_age, aes(x=factor(gender), y=Count, fill=factor(range))) + 
    geom_bar(stat="identity") + theme_bw() + ggtitle("Age of Top100 of Yes Decision3") +theme(plot.title = element_text(size=15, face="bold", 
    margin = margin(10, 0, 10, 0))) +labs(x="Gender", y="Number")+theme(legend.title=element_blank())
```